...
<#if !text?has_content>
  <#assign text=bp.getMessage(es.messageKeys.LOGIN_GENERAL_ERROR) />
</#if>
...
<div class="cm-box">
  ...
  <@bp.notification type="error" dismissable=false title=title!"" text=text!"" additionalClasses=["cm-box__content"] attr={
